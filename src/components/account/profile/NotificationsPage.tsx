...
export default function NotificationsPage() {
    ...
    const handleNotificationModal = () => {
        openModal('settings', <NotificationModal hideModal={() => 'settings'}/>)
    }
                ...
                <div className='notifications'>
                    <div className='notifications-content'>
                        ...
                        <div className='search-field'>
                            <input type="text" placeholder={t('Notifications.NotificationsList.SearchPlaceholder')} className='input-field'></input>
